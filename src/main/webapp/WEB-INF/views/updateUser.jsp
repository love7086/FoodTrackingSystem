...
<!-- 									Upload Photo </a></li> -->
								...
								<c:forEach var="user" items="${users}">
									<tr>
										...
										<td><input class="form-control pull-left"
											value="${user.role}" /></td>
										<td><input class="form-control pull-left"
											value="${user.person.name}" disabled /></td>
										<td>
		...
		<script>
			$(".btnSave").click(
					function() {
						var userId = $(this).parent().next().find("input")
								.val();
						var username = $(this).parent().prev().prev().prev()
								.find("input").val();
						var password = $(this).parent().prev().prev().find(
								"input").val();
						var role = $(this).parent().prev().find("input").val();
