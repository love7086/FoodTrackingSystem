	...
	<div id="wrap">
		...
		<div id="content">
			...
			<form id="form1" role="form" action="" method="post">
				<h3 id="success">Network successfully added!</h3>
				<h3 id="fail">Network adding failed</h3>
				<div class="form-group">
					<h2>
						<label>Please input the network name to add a network. </label>
					</h2>
					<h3>
						<input class="form-control" id="networkName" name="networkName"
							placeholder="Network name suggests the location of the network.">
					</h3>
					...
					function() {
						...
						$.post("addNetwork2.htm", {
							...
							if (json.flag == 1) {
								$("#fail").hide();
								$("#success").show();
								var tr = $("#networkTable").children("tbody")
										.append(
												"<tr><td>" + json.network
														+ "</td></tr>");
							}
