							...
							<tbody>
								<c:forEach var="food" items="${foodList}">
									<tr>
										...
										<td><input style="margin-top: 0px"
											class="form-control form-input" name="foodId" type="hidden"
											value="${food.foodId}" /><input style="margin-top: 0px"
											class="form-control form-input" name="showComments" type="button"
											value="Show Comments" /></td>
