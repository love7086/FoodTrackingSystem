...
<body class="padTop53 ">
	...
	<div id="wrap">
		...
		<!--left-->
		<div id="content">
			<div id="photoParent" class="pull-right">
				<div class="fileupload-preview thumbnail"
					style="width: 500px; height: 350px;">
					<c:if test="${src!=null}">
						<img src="<c:url value='/resources/img/${src}'/>" alt=""
							height="350px" width="500px" />
					</c:if>
				</div>
				<form id="myForm" action="uploadPhoto.htm" method='post'
					enctype='multipart/form-data'>
					Select Photo(Max 5Mb); <input type='file' id="photo" name="file"
						value="choose file" /> <input type="submit" id="mySubmit"
						value="submit" />
				</form>
			</div>
		</div>
