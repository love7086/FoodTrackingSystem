...
<!-- 									Upload Photo </a></li> -->
		...
		<script>
			$(".btnSave")
					.click(
							function() {
								var personId = $(this).next().next().next()
										.val();
								var personName = $(this).parent().prev().prev()
										.prev().find("input").val();
								var personAge = $(this).parent().prev().prev()
										.find("input").val();
								var personAddress = $(this).parent().prev()
										.find("input").val();
