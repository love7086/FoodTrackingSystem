		...
		<div id="content">
						...
						<table class="table" id="networkTable">
							...
							<tbody>
								<c:forEach var="network" items="${networkList}">
									<tr>
										<td><input class="networkName" type="radio"
											name="networkName"><label>&nbsp;&nbsp;&nbsp;</label><label>${network.name}</label></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
			...
			<form id="form1" role="form" action="" method="post">
				...
				<div class="form-group">
					<h2>
						<label>Please select the network and input the enterprise
							name and location to add a enterprise. </label>
					</h2>
					<h3>
						<input class="form-control " id="enterpriseName"
