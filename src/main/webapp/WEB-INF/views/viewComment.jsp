								...
								<c:forEach var="comment" items="${commentList}">
									<tr>
										<td><input style="margin-top: 0px"
											...
											value="${comment.food.name}" /></td>
										<td><input style="margin-top: 0px"
											class="form-control form-input" type="text"
											value="${comment.comment}" /></td>
										<td><input style="margin-top: 0px"
											class="form-control form-input" type="text"
											value="${comment.user}" /></td>
										<td><c:choose>
												<c:when test="${comment.user.username==sessionScope.user.username}">
													<input style="border-color:#b94a48" class="form-control form-input" type="text"
														value="asdasdads"  />
													<br />
												</c:when>
												<c:otherwise>
